...
#define RESET_ACTIVE() HAL_GPIO_WritePin(SPI1_RESET_GPIO_Port,SPI1_RESET_Pin,GPIO_PIN_RESET)
#define RESET_IDLE() HAL_GPIO_WritePin(SPI1_RESET_GPIO_Port,SPI1_RESET_Pin,GPIO_PIN_SET)
#define CS_ACTIVE() HAL_GPIO_WritePin(SPI1_CS_GPIO_Port,SPI1_CS_Pin,GPIO_PIN_RESET)
#define CS_IDLE() HAL_GPIO_WritePin(SPI1_CS_GPIO_Port,SPI1_CS_Pin,GPIO_PIN_SET)
#define DC_COMMAND() HAL_GPIO_WritePin(SPI1_RS_GPIO_Port,SPI1_RS_Pin,GPIO_PIN_RESET)
#define DC_DATA() HAL_GPIO_WritePin(SPI1_RS_GPIO_Port,SPI1_RS_Pin,GPIO_PIN_SET)
//-------------------------------------------------------------------
